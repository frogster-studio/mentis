            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-zinc-50 hover:bg-zinc-50">
                  <TableHead className="pl-4 text-muted-foreground text-xs">Title</TableHead>
                  <TableHead className="text-muted-foreground text-xs">Card Type</TableHead>
                  <TableHead className="text-muted-foreground text-xs">Tags</TableHead>
                  <TableHead className="text-muted-foreground text-xs">Socials</TableHead>
                  <TableHead className="pr-4 text-muted-foreground text-xs">Updated</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {items.length === 0 ? (
