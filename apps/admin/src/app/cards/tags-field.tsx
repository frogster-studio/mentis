  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <p className="text-muted-foreground text-xs">
        Shared rules: Tags are lowercase French, without accents (é, à…) or punctuation; anglicisms
        are fine when French has no real equivalent (shopping, startup). Keep them singular (animal,
        not animaux) and prefer a single word — or one multi-word Tag when needed (developpement
