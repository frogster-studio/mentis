...
export const PICKER_HELP_LABEL = "Aide";
export const PICKER_CLASSIC_TAB_LABEL = "Classique";
export const PICKER_CUSTOM_TAB_LABEL = "Personnalisé";
export const CUSTOM_PICKER_TITLE = "Sur-mesure";
