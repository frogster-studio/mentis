...
- **`CONTEXT-MAP.md`** at the repo root — it maps the bounded contexts and points at one `CONTEXT.md` per context. Read each one relevant to the topic.
...
This is a **multi-context** repo — two bounded contexts mapped by the root `CONTEXT-MAP.md`:
